...
plot_traceplot <- function(out){
  ...
  # plot(out, start = 10, parametersOnly = F, whichParameters = c("disruption", "inf_imm1", "inf_imm2", "waning1", "waning2", "aging1", "aging2", "Llikelihood")) # uncomment if lambda is also fitted
  dev.off()
