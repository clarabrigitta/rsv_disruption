...
for(m in 1:12){
  data <- get(paste0("births_", month.abb[m])) %>% 
...
for(m in 1:12){
  assign(paste0("births_", month.abb[m]), readRDS(file = paste0("/Users/lsh2301561/Desktop/rsv_disruption/output/data/monthly/births_", month.abb[m],".rds")))
