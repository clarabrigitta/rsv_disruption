...
create_trajectory_infection <- function(lambda, theta1, theta2, omega1, omega2, alpha1, alpha2, stored_data, delta, n_interest){
  ...
  data <- do.call(rbind, data)[, c(1, 6+n_interest, 9+n_interest)] # unlist map output
