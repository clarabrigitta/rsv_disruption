...
women.long <- ifelse(disruption == FALSE, readRDS(file = "./output/data/women/women_long.rds"), readRDS(women.long, file = "./output/data/women/women_long_disrupt.rds"))
...
saveRDS(women.prop, file = "./output/data/women/women_prop.rds")