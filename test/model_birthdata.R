...
n_burn <- 25 # burn-in period

women.disrupt <- women
# women.disrupt[(12*n_burn+3):(12*(n_burn+1)+3), "rate"] <- 0 # setting disruption after 25 year burn-in, 0 between March
women.disrupt[(12*n_burn+3):(12*(n_burn+1)+10), "rate"] <- as.data.frame(c(rep(0, 13), seq(0.1, 0.7, 0.1))) # setting disruption after 25 year burn-in, 0 between March then step-wise until November 
